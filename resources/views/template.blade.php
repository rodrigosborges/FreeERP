    ...
    <div class="d-flex">
        ...
        <div class="d-flex flex-column" id="workspace">
            <div class="shadow-sm d-flex align-items-center justify-content-between" id="header">
                ...
                <div class="d-flex align-items-center">
                    <i class="material-icons  mr-2 btn-circle" data-toggle='dropdown'>apps</i>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="{{route('modulo.os.acompanharOS')}}">Ordem Serviço</a>
                        <a class="dropdown-item" href="{{url('/usuario')}}">Usuários</a>
                    </div>
