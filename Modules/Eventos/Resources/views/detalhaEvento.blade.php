        ...
        <div class="col-xm-12 col-sm-12 col-md-12 col-lg-12 borda">
            ...
            <ul class="nav nav-tabs">
                @foreach($programacao as $atividade)
                    @if($loop->first)
                        <li class="nav-item">
                            <a class="nav-link active" href="#{{$atividade->id}}">{{\Carbon\Carbon::parse($atividade->data)->format('d/m')}}</a>
                        </li>
                    @else
                        <li class="nav-item">
                            <a class="nav-link" href="#{{$atividade->id}}">{{\Carbon\Carbon::parse($atividade->data)->format('d/m')}}</a>
                        </li>
                    @endif
                @endforeach
            </ul>
            ...
            <div class="tab-content">
                @foreach($programacao as $atividade)
                    ...
                    <!-- Modal para visualizar as atividades do evento -->
