...
<form action="{{url($data['url'])}}" method="POST">
    ...
    <div class="row">
        ...
        <div class="form-group col-6">
            ...
            <input type="text" name='nome' id="nome" class="form-control" maxlength="45" value=""  placeholder="ex: (Caixa, container, unidade)"> 
            <p class=" alert-warning">{{$errors->first('nome')}} </p>
        </div>
        <div class="col-6">
            <div class="form-group">
                <label for="categoria_id">quantidade de itens</label>
                <input type="number" name="quantidade_itens" class="form-control">
