...
@section('content')
    ...
    <form action="{{ $data['url'] }}" method="POST">
        ...
        <strong><h4 class="mt-5 mb-3">Fornecedor</h4></strong>
        <hr>
        ...
        <div class="form-group">
            ...
            <input type="email" required name="email[email]" id="email" class="form-control" value="{{ $data['model'] ? $data['model']->email->email : old('email', "") }}">
            <label class="errors"> {{ $errors->first('email.email') }} </label>
        </div>

        <strong><h4 class="mt-5 mb-3">Endereço</h4></strong>
        <hr>
        <div class="row">
            <div class="col-md-2">
                <div class="form-group">
        ...
        <strong><h4 class="mt-5 mb-3">Contato</h4></strong>
        <hr> 
        ...
        <div class="form-group">
            <label for="numero" class="control-label">Número</label>
            <input type="text" required name="telefone[numero]" id="numero" class="form-control" value="{{ $data['model'] ? $data['model']->telefones->numero : old('numero', "") }}">
