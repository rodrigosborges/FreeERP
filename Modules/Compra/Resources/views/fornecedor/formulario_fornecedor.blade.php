...
@section('content')
    ...
    <form action="{{ $data['url'] }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" required name="nome_fornecedor" id="nome_fornecedor" class="form-control" value="{{ $data['model'] ? $data['model']->nome_fornecedor : old('nome_fornecedor', "") }}">
        ...
        <div class="form-group">
            ...
            <input type="text" required name="endereco" id="endereco" class="form-control" value="{{ $data['model'] ? $data['model']->endereco : old('endereco', "") }}">
            <label class="errors"> {{ $errors->first('endereco') }} </label>
        </div>
        
        <div class="form-group">
            <label for="telefone" class="control-label">Telefone</label>
            <input type="text" required name="telefone" id="telefone" class="form-control" value="{{ $data['model'] ? $data['model']->telefone : old('telefone', "") }}">
