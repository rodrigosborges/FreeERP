...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21-Set-2019 às 16:29
...
INSERT INTO `funcionario` (`id`, `nome`, `data_nascimento`, `sexo`, `data_admissao`, `estado_civil_id`, `email_id`, `endereco_id`, `created_at`, `updated_at`, `deleted_at`, `gestor_id`) VALUES
(5, 'Nikolas Lencioni', '1995-08-09', 1, '2019-09-21', 2, 1, 1, '2019-09-21 03:00:00', '2019-09-21 03:00:00', NULL, NULL),
(6, 'Deborah Donofrio', '1999-06-19', 2, '2019-09-04', 2, 2, 2, '2019-09-21 03:00:00', '2019-09-21 03:00:00', NULL, 5),
(7, 'Raul Barbosa Lencioni', '2019-04-09', 1, '2019-09-01', 1, 3, 3, '2019-09-21 03:00:00', '2019-09-21 03:00:00', NULL, 6),
(8, 'Manuella Barbosa Lencioni', '2019-08-09', 2, '2019-09-04', 1, 7, 7, '2019-09-21 03:00:00', '2019-09-21 03:00:00', NULL, 5);
...
ALTER TABLE `funcionario`
  ...
  ADD KEY `funcionario_gestor_id_foreign` (`gestor_id`);
...
ALTER TABLE `funcionario`
  ...
  ADD CONSTRAINT `funcionario_gestor_id_foreign` FOREIGN KEY (`gestor_id`) REFERENCES `funcionario` (`id`);
