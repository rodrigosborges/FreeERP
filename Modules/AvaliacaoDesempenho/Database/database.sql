...
--
-- Host: 127.0.0.1
-- Tempo de geração: 03-Nov-2019 às 17:26
...
--
-- Estrutura da tabela `avaliacao_has_questao`
--
...
CREATE TABLE `documento` (
  ...
  `comprovante` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `documento` (`id`, `numero`, `comprovante`, `tipo_documento_id`) VALUES
(1, '377826637', NULL, 2),
(2, '38391928896', NULL, 1),
(3, '121447388', NULL, 2),
(4, '37182893509', NULL, 1);
...
(3, 'raul@hotmail.com'),
(4, 'manuella@hotmail.com'),
(5, 'marcella@hotmail.com'),
(6, 'joao@hotmail.com'),
(7, 'matheus@hotmail.com'),
(8, 'paulo@hotmail.com'),
(9, 'lucas@hotmail.com'),
(10, 'adao@hotmail.com');
...
(1, 'Av. Maestro Heitor de Carvalho', 655, 'Massaguaçu', 1, '11677040', NULL),
(2, 'Av. Siqueira Campos', 12, 'Centro', 2, '11657909', NULL),
(3, 'Av Tiradentes', 2008, 'Luz', 3, '11455362', NULL),
(7, 'Rua George Ohm', 203, 'Cidade Monções', 3, '12767889', 'Torre A, Sala 54');
...
CREATE TABLE `folha_pagamento` (
  ...
  `horas_extras` double(3,2) DEFAULT NULL,
  `adicional_noturno` double(3,2) DEFAULT NULL,
  `inss` double(3,2) NOT NULL,
...
(1, 'Nikolas',  '1995-08-09', 1, '2019-09-21', 2, 1, 1, 1, NULL, '2019-09-21 03:00:00', '2019-09-21 03:00:00', NULL),
(2, 'Deborah',  '1999-06-19', 2, '2019-09-04', 2, 2, 2, 1, 4, '2019-09-21 03:00:00', '2019-09-21 03:00:00', NULL),
(3, 'Raul',     '2019-04-09', 1, '2019-09-01', 1, 3, 3, 2, 3, '2019-09-21 03:00:00', '2019-09-21 03:00:00', NULL),
(4, 'Manuella', '2019-08-09', 2, '2019-09-05', 1, 4, 7, 2, 1, '2019-09-21 03:00:00', '2019-09-21 03:00:00', NULL),
(5, 'Marcella', '2019-08-09', 2, '2019-09-10', 1, 5, 7, 2, 2, '2019-09-21 03:00:00', '2019-09-21 03:00:00', NULL),
(6, 'João',     '2019-08-09', 1, '2019-09-20', 1, 6, 7, 1, 4, '2019-09-21 03:00:00', '2019-09-21 03:00:00', NULL),
(7, 'Matheus',  '2019-08-09', 1, '2019-09-05', 1, 7, 1, 1, 4, '2019-09-21 03:00:00', '2019-09-21 03:00:00', NULL),
(8, 'Paulo',    '2019-08-09', 1, '2019-09-10', 1, 8, 2, 2, 2, '2019-09-21 03:00:00', '2019-09-21 03:00:00', NULL),
(9, 'Lucas',    '2019-08-09', 1, '2019-09-20', 1, 9, 3, 3, 3, '2019-09-21 03:00:00', '2019-09-21 03:00:00', NULL),
(10, 'Adão',    '2019-08-09', 1, '2019-09-20', 1, 10, 3, 3, 1, '2019-09-21 03:00:00', '2019-09-21 03:00:00', NULL);

-- --------------------------------------------------------

--
-- Estrutura da tabela `funcionario_has_documento`
--

CREATE TABLE `funcionario_has_documento` (
  `funcionario_id` int(11) NOT NULL,
  `documento_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Extraindo dados da tabela `funcionario_has_documento`
--

INSERT INTO `funcionario_has_documento` (`funcionario_id`, `documento_id`) VALUES
(5, 2),
(6, 3),
(7, 1),
(8, 4);
...
--
-- Estrutura da tabela `funcionario_has_telefone`
--
...
--
-- Extraindo dados da tabela `funcionario_has_telefone`
--

INSERT INTO `funcionario_has_telefone` (`funcionario_id`, `telefone_id`) VALUES
(5, 1),
(6, 2),
(7, 3),
(8, 4);
...
--
-- Estrutura da tabela `historico_cargo`
--
...
--
-- Extraindo dados da tabela `historico_cargo`
--

INSERT INTO `historico_cargo` (`id`, `cargo_id`, `funcionario_id`, `data_entrada`, `data_saida`) VALUES
(1, 1, 5, '2019-09-01', NULL),
(2, 2, 6, '2019-09-01', NULL),
(3, 2, 8, '2019-09-01', NULL),
(4, 2, 7, '2019-09-01', NULL);
...
(1, '2019_08_20_170140_create_cargo_table', 1),
(2, '2019_08_20_170140_create_cidade_table', 1),
(3, '2019_08_20_170140_create_dependente_table', 1),
(4, '2019_08_20_170140_create_documento_table', 1),
(5, '2019_08_20_170140_create_email_table', 1),
(6, '2019_08_20_170140_create_endereco_table', 1),
(7, '2019_08_20_170140_create_estado_civil_table', 1),
(8, '2019_08_20_170140_create_estado_table', 1),
(9, '2019_08_20_170140_create_funcionario_has_documento_table', 1),
(10, '2019_08_20_170140_create_funcionario_has_telefone_table', 1),
(11, '2019_08_20_170140_create_funcionario_table', 1),
(12, '2019_08_20_170140_create_historico_cargo_table', 1),
(13, '2019_08_20_170140_create_parentesco_table', 1),
(14, '2019_08_20_170140_create_telefone_table', 1),
(15, '2019_08_20_170140_create_tipo_documento_table', 1),
(16, '2019_08_20_170140_create_tipo_telefone_table', 1),
(17, '2019_08_20_170142_add_foreign_keys_to_cidade_table', 1),
(18, '2019_08_20_170142_add_foreign_keys_to_dependente_table', 1),
(19, '2019_08_20_170142_add_foreign_keys_to_documento_table', 1),
(20, '2019_08_20_170142_add_foreign_keys_to_endereco_table', 1),
(21, '2019_08_20_170142_add_foreign_keys_to_funcionario_has_documento_table', 1),
(22, '2019_08_20_170142_add_foreign_keys_to_funcionario_has_telefone_table', 1),
(23, '2019_08_20_170142_add_foreign_keys_to_funcionario_table', 1),
(24, '2019_08_20_170142_add_foreign_keys_to_historico_cargo_table', 1),
(25, '2019_08_20_170142_add_foreign_keys_to_telefone_table', 1),
(26, '2019_08_25_164753_create_folha_pagamento', 1),
(27, '2019_08_25_171548_create_adiantamento', 1),
(28, '2019_09_21_001_create_gestor_id_column', 1),
(29, '2019_09_21_002_create_processo_table', 1),
(30, '2019_09_21_003_create_setor_table', 1),
(31, '2019_09_21_004_create_avaliacao_table', 1),
(32, '2019_09_21_005_create_categoria_table', 1),
...
INSERT INTO `setor` (`id`, `nome`, `gestor_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Financeiro', 2, '2019-10-02 03:00:00', '2019-10-05 14:11:05', NULL),
(2, 'Juridico', 6, '2019-10-02 03:00:00', '2019-10-02 03:00:00', NULL),
(3, 'Operacional', 7, '2019-10-02 03:00:00', '2019-10-02 03:00:00', NULL),
(4, 'Gerencia', 1, '2019-10-02 03:00:00', '2019-10-02 03:00:00', NULL);
...
INSERT INTO `telefone` (`id`, `tipo_telefone_id`, `numero`) VALUES
(1, 2, '12982117333'),
(2, 2, '12981259918'),
(3, 2, '12981267222'),
(4, 2, '12981944343');
...
INSERT INTO `tipo_telefone` (`id`, `nome`) VALUES
(1, 'Residencial'),
(2, 'Celular'),
(3, 'Comercial');
...
ALTER TABLE `adiantamento`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_adiantamento_folha_pagamento1` (`folha_pagamento_id`);
...
ALTER TABLE `avaliacao_has_questao`
  ADD PRIMARY KEY (`id`),
  ADD KEY `avaliacao_has_questao_avaliacao_id_foreign` (`avaliacao_id`),
  ADD KEY `avaliacao_has_questao_questao_id_foreign` (`questao_id`);

--
-- Índices para tabela `avaliado`
--
ALTER TABLE `avaliado`
  ADD PRIMARY KEY (`id`),
  ADD KEY `avaliado_funcionario_id_foreign` (`funcionario_id`),
...
ALTER TABLE `dependente`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_dependente_funcionario` (`funcionario_id`),
  ADD KEY `fk_dependente_parentesco` (`parentesco_id`);
...
ALTER TABLE `documento`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_documento_tipo_documento` (`tipo_documento_id`);
...
ALTER TABLE `endereco`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_endereco_cidade1` (`cidade_id`);
...
--
-- Índices para tabela `folha_pagamento`
--
ALTER TABLE `folha_pagamento`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_folha_pagamento_funcionario1` (`funcionario_id`);
...
--
-- Índices para tabela `funcionario_has_documento`
--
ALTER TABLE `funcionario_has_documento`
  ADD PRIMARY KEY (`funcionario_id`,`documento_id`),
  ADD KEY `fk_funcionario_has_documento_documento1` (`documento_id`);

--
-- Índices para tabela `funcionario_has_telefone`
--
ALTER TABLE `funcionario_has_telefone`
  ADD PRIMARY KEY (`funcionario_id`,`telefone_id`),
  ADD KEY `fk_funcionario_has_telefone_telefone1` (`telefone_id`);

--
-- Índices para tabela `historico_cargo`
--
ALTER TABLE `historico_cargo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_historico_cargo_cargo` (`cargo_id`),
  ADD KEY `fk_historico_cargo_funcionario` (`funcionario_id`);
...
ALTER TABLE `processo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `processo_funcionario_id_foreign` (`funcionario_id`),
  ADD KEY `processo_status_id_foreign` (`status_id`);
...
ALTER TABLE `questao`
  ADD PRIMARY KEY (`id`),
  ADD KEY `questao_categoria_id_foreign` (`categoria_id`);
...
--
-- AUTO_INCREMENT de tabela `adiantamento`
--
ALTER TABLE `adiantamento`
...
--
-- AUTO_INCREMENT de tabela `resultado_gestor`
--
ALTER TABLE `resultado_gestor`
...
--
ALTER TABLE `dependente`
  ADD CONSTRAINT `fk_dependente_funcionario` FOREIGN KEY (`funcionario_id`) REFERENCES `funcionario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_dependente_parentesco` FOREIGN KEY (`parentesco_id`) REFERENCES `parentesco` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `documento`
--
ALTER TABLE `documento`
  ADD CONSTRAINT `fk_documento_tipo_documento` FOREIGN KEY (`tipo_documento_id`) REFERENCES `tipo_documento` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `funcionario_has_documento`
  ADD CONSTRAINT `fk_funcionario_has_documento_documento1` FOREIGN KEY (`documento_id`) REFERENCES `documento` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_funcionario_has_documento_funcionario1` FOREIGN KEY (`funcionario_id`) REFERENCES `funcionario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `funcionario_has_telefone`
--
ALTER TABLE `funcionario_has_telefone`
  ADD CONSTRAINT `fk_funcionario_has_telefone_funcionario1` FOREIGN KEY (`funcionario_id`) REFERENCES `funcionario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_funcionario_has_telefone_telefone1` FOREIGN KEY (`telefone_id`) REFERENCES `telefone` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `historico_cargo`
--
ALTER TABLE `historico_cargo`
  ADD CONSTRAINT `fk_historico_cargo_cargo` FOREIGN KEY (`cargo_id`) REFERENCES `cargo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_historico_cargo_funcionario` FOREIGN KEY (`funcionario_id`) REFERENCES `funcionario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `processo`
--
ALTER TABLE `processo`
  ADD CONSTRAINT `processo_funcionario_id_foreign` FOREIGN KEY (`funcionario_id`) REFERENCES `funcionario` (`id`),
  ADD CONSTRAINT `processo_status_id_foreign` FOREIGN KEY (`status_id`) REFERENCES `status` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `questao`
--
ALTER TABLE `questao`
  ADD CONSTRAINT `questao_categoria_id_foreign` FOREIGN KEY (`categoria_id`) REFERENCES `categoria` (`id`);
...
--
ALTER TABLE `setor`
  ADD CONSTRAINT `fk_setor_funcionario1` FOREIGN KEY (`gestor_id`) REFERENCES `funcionario` (`id`);

--
-- Limitadores para a tabela `telefone`
--
ALTER TABLE `telefone`
  ADD CONSTRAINT `fk_telefone_tipo_telefone1` FOREIGN KEY (`tipo_telefone_id`) REFERENCES `tipo_telefone` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
