      ...
      <tbody>
        @foreach ($clientesDeletados as $cliente)
          <tr>
            ...
            <td>
              <a href="{{route('cliente.editar', $cliente->id)}}"><button type="button" class="btn btn-secondary">Editar</button></a>
              <a href="{{route('cliente.deletar', $cliente->id)}}"><button type="button" class="btn btn-warning">Ativar</button></a>
            </td>
          </tr>
        @endforeach
      </tbody>
      <tfoot>
          <tr>
              ...
              <p class="text-center">
                  ...
                  Página {{$clientesDeletados->currentPage()}} de {{$clientesDeletados->lastPage()}} páginas
