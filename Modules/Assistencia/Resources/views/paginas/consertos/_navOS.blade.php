<ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link" id="sobre-tab" data-toggle="tab" href="#sobre" role="tab" aria-controls="sobre"
            aria-selected="false">Sobre O.S.</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="pecas-tab" data-toggle="tab" href="#pecas" role="tab" aria-controls="pecas"
            aria-selected="false">Peças</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="maoObra-tab" data-toggle="tab" href="#maoObra" role="tab" aria-controls="maoObra"
            aria-selected="false">Mão de Obra</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="tecnico-tab" data-toggle="tab" href="#tecnico" role="tab" aria-controls="tecnico"
