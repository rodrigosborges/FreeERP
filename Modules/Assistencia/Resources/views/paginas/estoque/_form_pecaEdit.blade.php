...
<div class="form-group col-12">
    <input class="form-control" id="qnt" name="quantidade" type="text" maxlength="2" placeholder="Quantidade" disabled
                ...
                <div class="row">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('itemPeca.deletar',$item->id)}}"><button type="button"
