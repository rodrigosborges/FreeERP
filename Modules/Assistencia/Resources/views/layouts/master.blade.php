...
<html>
    ...
    <body>
        ...
        <script src="{{Module::asset('assistencia:js/bibliotecas/jquery-1.12.4.js')}}"></script>
        <script src="{{Module::asset('assistencia:js/bibliotecas/jquery-ui.js')}}"></script>
        <script src="{{Module::asset('assistencia:js/bibliotecas/popper.min.js')}}"></script>
        <script src="{{Module::asset('assistencia:js/bibliotecas/jquery.mask.js')}}"></script>
        <script src="{{Module::asset('assistencia:js/bibliotecas/bootstrap.min.js')}}"></script>
