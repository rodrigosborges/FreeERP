...
use App\Entities\TipoTelefone;use Auth;use Carbon\Carbon;use DateTime;use DB;
use Gate;use Illuminate\Http\Request;use Illuminate\Http\Response;use Illuminate\Routing\Controller;use Illuminate\Support\Facades\Storage;
use Modules\Funcionario\Entities\Atestado;
use Modules\Funcionario\Entities\AvisoPrevio;
use Modules\Funcionario\Entities\AvisoPrevioIndenizado;

use Modules\Funcionario\Entities\Cargo;
use Modules\Funcionario\Entities\Curso;

use Modules\Funcionario\Entities\Demissao;

use Modules\Funcionario\Entities\Dependente;
use Modules\Funcionario\Entities\Funcionario;

use Modules\Funcionario\Entities\Parentesco;

use Modules\Funcionario\Http\Requests\CreateDemissao;
